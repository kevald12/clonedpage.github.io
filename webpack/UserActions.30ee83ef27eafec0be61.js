            ...
            var m = t => {
                switch (t.name) {
                    case "click:BOOKMARK_ADD": {
                        ...
                        }), !s["".concat(e, "s")].includes(a) && s["".concat(e, "s")].push(a), u(s), (0, n.sY)("bookmark-".concat(e, "-").concat(a), i({
                            disabled: !0,
                            size: t.detail.size,
                            count: t.detail.count ? t.detail.count + 1 : null,
                            id: a,
                    ...
                    case "click:BOOKMARK_REMOVE": {
                        ...
                        }), l["".concat(e, "s")].includes(a) && o()(l["".concat(e, "s")], (t => t === a)), u(l), (0, n.sY)("bookmark-".concat(e, "-").concat(a), i({
                            disabled: !0,
                            size: t.detail.size,
                            count: t.detail.count ? t.detail.count - 1 : null,
                            id: a,
                    ...
                    switch (t.name) {
                        ...
                        case "mouseenter:FOLLOW_ROW": {
                            const a = t.target.querySelector("[data-offset-src]"),
                                e = a.offsetLeft;
                            (0, s.cn)("invisible", a), t.target.querySelector("[data-offset-target]").style.left = "".concat(e, "px");
                            break
                        }
            ...
            y({
                ...
                switch (t.name) {
                    case "scroll:LISTS_TABLE": {
                        ...
                        t.target.scrollTop >= t.target.scrollHeight - t.target.offsetHeight - 10 ? (0, p.cn)("hidden", a) : (0, p.IV)("hidden", a);
                        break
                    }
                    ...
                    case "submit:LIST_CREATE": {
                        ...
                        const a = new FormData(t.target),
                            ...
                            l = h();
                        l.addToList = l.addToList || {}, l.addToList.status = "processing", y(l), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)())), (0, g.Z)("LISTS/CREATE", {
                            data: e
                        });
                        break
                    }
                    ...
                    case "request:LIST/REMOVE_ERROR": {
                        ...
                        }(0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)())), (0, v.default)();
                        break
                    }
                    case "request:LISTS/CREATE_ERROR": {
                        const a = h();
                        if (!a.addToList || !a.addToList.id) return;
                        a.addToList.status = null, y(a), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)())), o.Z.error("[data-name=LIST_CREATE]", t.detail.json.message);
                        break
                    }
                    case "request:LISTS/CREATE_SUCCESS": {
                        ...
                        a.available.unshift({
                            ...
                            titleValue: null,
                            privacyValue: 0
                        }, y(a), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)()));
                        break
                    }
                    ...
                    case "click:LIST_SHOW_CREATE": {
                        var e;
                        const t = h();
                        t.addToList.creating = !0, y(t), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)())), null === (e = document.querySelector("[data-name=LIST_CREATE]").querySelector("input[name=listName]")) || void 0 === e || e.focus();
                        break
                    }
                    case "click:LIST_CREATE_CANCEL": {
                        const t = h();
                        t.addToList.creating = !1, t.form = {
                            titleValue: null,
                            privacyValue: 0
                        }, y(t), (0, n.sY)("modal-add-to-list", (0, s.Z)((0, n.y0)()));
                        break
                    }
                }
            }
            ...
            a.default = t => {
                switch (t.name) {
                    case "click:DOCUMENT": {
                        ...
                        a.length && [].slice.call(a).forEach((t => {
                            if (t.querySelector(".cmpt-select-date-overlay")) {
                                ...
                                (0, l.sY)("date-select-".concat(a.name, "-").concat(a.id), (0, n.Z)({
                                    ...a,
                                    ...i,
                                    isActive: !1
                                }), (t => {
                    ...
                    case "click:SELECT_DATE":
                        "click:SELECT_DATE" === t.name && (i.month = t.detail.month, i.year = t.detail.year), (0, l.sY)("date-select-".concat(t.detail.name, "-").concat(t.detail.id), (0, n.Z)({
                            ...t.detail,
                            ...i,
                    ...
                    case "mousedown:CLEAR_YEAR": {
                        ...
                        i[s] = "clear" === e ? "" : t.detail[s], (0, l.sY)("date-select-".concat(t.detail.name, "-").concat(t.detail.id), (0, n.Z)({
                            ...t.detail,
                            ...i
                        }), (t => {
                    ...
                    case "blur:SELECT_DATE_INPUT_YEAR":
                        (0, l.sY)("date-select-".concat(t.detail.name, "-").concat(t.detail.id), (0, n.Z)({
                            ...t.detail,
                            ...i
                        }));
                        break;
                    case "keyup:SELECT_DATE_INPUT_MONTH": {
                        let a = null;
                        (0, s.df)(t.target.value) && (a = (0, s.df)(t.target.value).number), parseInt(t.target.value, 10) >= 0 && (0, s.SV)(t.target.value) && (a = (0, s.SV)(t.target.value).number), i.month = a;
                        break
                    }
