            ...
            t.default = e => {
                switch (e.name) {
                    ...
                    case "click:MENU_SIDEBAR": {
                        ...
                        if (t.classList.contains("animate-slide-in-right")) return (0, l.IV)("animate-slide-in-right", t), (0, l.cn)("animate-slide-out-left", t), (0, l.IV)("icon-x-charcoal", a), void(0, l.cn)("icon-menu-charcoal", a);
                        t.style.top = "".concat(e, "px"), (0, l.cn)("animate-slide-in-right", t), (0, l.IV)("icon-menu-charcoal", a), (0, l.cn)("icon-x-charcoal", a);
                        break
                    }
                }
            }
