                ...
                switch (t.name) {
                    case "request:PROGRESS/UPDATE_SUCCESS": {
                        const {
                            id: e,
                            type: n
                        } = t.detail.originalParameters, a = t.detail.originalData, l = "".concat(n, "-").concat(e), i = b();
                        i[l].status = "success", i[l].completed = a.metadata.user.completed, h(i), v(l);
                        break
                    }
                    case "submit:PROGRESS_COMPLETE": {
                        ...
                        const {
                            id: a,
                            type: l
                        } = t.detail, r = "".concat(l, "-").concat(a), c = b(), d = !!t.name.match(/COMPLETE/), p = (null === (e = t.target.elements) || void 0 === e || null === (n = e.completedStartDate) || void 0 === n ? void 0 : n.value) || null, m = (null === (s = t.target.elements) || void 0 === s || null === (o = s.completedEndDate) || void 0 === o ? void 0 : o.value) || null, u = {};
                        if (p && !(0, i.qS)(p) && (u.completedStartDate = !0), m && !(0, i.qS)(m) && (u.completedEndDate = !0), c[r] = {
                                ...c[r],
                                id: a,
                                type: l,
                                ...
                                completedEndDate: m,
                                errors: u
                            }, Object.keys(u).length) return h(c), v(r);
                        c[r].status = "".concat(c[r].status, ":processing"), h(c), v(r);
                        const y = {
                            metadata: {
                                user: {
                                    completed: d,
                    ...
                    case "click:PROGRESS_TRIGGER": {
                        ...
                        const {
                            ...
                            completed: i,
                            reviewed: s
                        } = t.detail, o = "".concat(n, "-").concat(e), r = b();
                        ...
                        }, r[o].status = (r[o].status || "").match(/active|success/) ? null : "active", h(r), v(o);
                        break
                    }
                }
            }
