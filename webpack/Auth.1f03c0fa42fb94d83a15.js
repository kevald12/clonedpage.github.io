            ...
            (0, a.IW)({
                ...
                switch (e.name) {
                    ...
                    case "scroll:DOCUMENT": {
                        const e = (0, a.Bm)().deferred.images;
            ...
            t.default = e => {
                switch (e.name) {
                    ...
                    case "pointerover:NAV_SUBSECTION_PARENT": {
                        ...
                        if (e.originalEvent.preventDefault(), null === o.querySelector(".js-main-nav-subsection:not([hidden])")) return void d(e.detail.childListId);
                        null !== h && clearTimeout(h);
                        let t = e.originalEvent.target,
                            n = t.dataset.name && "NAV_SUBSECTION_PARENT" === t.dataset.name ? t : t.closest('[data-name="NAV_SUBSECTION_PARENT"]');
                        h = setTimeout((() => {
            ...
            t.default = e => {
                switch (e.name) {
                    ...
                    case "click:MENU_SIDEBAR": {
                        ...
                        if (t.classList.contains("animate-slide-in-right")) return (0, o.IV)("animate-slide-in-right", t), (0, o.cn)("animate-slide-out-left", t), (0, o.IV)("icon-x-charcoal", n), void(0, o.cn)("icon-menu-charcoal", n);
                        t.style.top = "".concat(e, "px"), (0, o.cn)("animate-slide-in-right", t), (0, o.IV)("icon-menu-charcoal", n), (0, o.cn)("icon-x-charcoal", n);
                        break
                    }
                }
            }
            ...
            var u = e => {
                switch (e.name) {
                    ...
                    case "click:BLANKET": {
                        ...
                        e.name.match(/click/) && (t = (0, a.y0)().nav.activeDropdown === e.detail.name ? null : e.detail.name), (0, a.IW)({
                            nav: {
                                ...(0, a.y0)().nav,
                                activeDropdown: t,
                                blanket: !!t
                            }
                        }), (0, o.W)("notification", "CLEAR_ALL"), s((0, a.y0)()), "lists" === e.detail.name && ((0, a.sY)("modal"), window.requestAnimationFrame((() => {
                            window.scrollTo({
                                top: 0,
                                left: 0,
                                behavior: "smooth"
                            })
                        })), (0, o.W)("load", "NAV_LISTS")), t ? (0, o.W)("load", "NAV_SHOW") : (0, o.W)("load", "NAV_HIDE");
                        break
                    }
            ...
            var d = e => {
                switch (e.name) {
                    ...
                    case "notification:SHOW": {
                        ...
                        const l = (0, a.y0)().notifications;
                        l.push({
                            ...e.detail,
                            body: n
                        }), r(l), c(), s && clearTimeout(s), s = setTimeout((() => {
                            (0, i.W)("notification", "CLEAR_ALL")
                        }), e.detail.delay ? e.detail.delay : 0);
                        break
                    }
                    case "click:CLEAR_NOTIFICATION": {
                        const t = (0, a.y0)().notifications;
                        t.splice(e.detail.index, 1), r(t), c();
                        break
                    }
                    case "scroll:DOCUMENT":
            ...
            var z = e => {
                switch (e.name) {
                    ...
                    case "keyup:MOBILE_AUTOCOMPLETE_SEARCHBOX": {
                        ...
                        if (B(), k = t.value, "" === k) return void V("");
                        Z = setTimeout((function () {
                            q(t.value), j(t.value)
                        }), 500);
                        break
                    ...
                    case "focus:MOBILE_AUTOCOMPLETE_SEARCHBOX": {
                        const t = e.originalEvent.target;
                        t.parentElement.querySelector('[data-name="AUTOCOMPLETE_CLEAR"][aria-controls="'.concat(t.id, '"]')).hidden = !1;
                        break
                    }
                    case "blur:AUTOCOMPLETE_SEARCHBOX":
                    case "blur:MOBILE_AUTOCOMPLETE_SEARCHBOX": {
                        const t = e.originalEvent.target,
                            n = t.parentElement.querySelector('[data-name="AUTOCOMPLETE_CLEAR"][aria-controls="'.concat(t.id, '"]'));
                        setTimeout((() => {
            ...
            var w = e => {
                switch (e.name) {
                    ...
                    case "signup:SIGNUP_INTENT": {
                        ...
                        window.location.assign("".concat(_).concat((0, g.h3)({
                            ...t,
                    ...
                    case "submit:SIGNUP_FORM": {
                        e.originalEvent.preventDefault(), (0, c.sY)("signup-submit-button", (0, h.Z)({
                        ...
                        t.has("frc-captcha-solution") && (n.friendly_captcha_solution = t.get("frc-captcha-solution")), t.has("skip_onboarding") && (n.skip_onboarding = t.get("skip_onboarding")), null !== t.get("exit_to_url") && (n.onboarding_exit_url = t.get("exit_to_url")), (0, d.Z)("CREATE_USER", {
                            data: n
                        });
                        break
                    }
